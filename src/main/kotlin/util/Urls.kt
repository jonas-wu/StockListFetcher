...
object Urls {
     ...
     */
    const val STOCK_INFO_URL_QT = "http://qt.gtimg.cn/q=%s"
    const val STOCK_DAY_PRICES_URL_QT =
        "https://data.gtimg.cn/flashdata/hushen/latest/daily/%s.js?visitDstTime=1"
    const val STOCK_INDUSTRY_URL_FINANCE = "https://finance.ifeng.com/app/hq/stock/%s/index.shtml"
}